...
export default async function ProductPage({ params }) {
  ...
  return (
    <div className="bg-white rounded-[2.5rem] p-8 lg:p-14 shadow-xl shadow-gray-200/40 border border-gray-100 mt-8 mb-20 relative overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="flex flex-col pt-4">
           ...
           <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight mb-6">{product.name}</h1>
